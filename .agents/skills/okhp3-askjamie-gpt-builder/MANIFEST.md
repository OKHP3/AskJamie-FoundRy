# AskJamie GPT Builder Skill Manifest

## Package

- **Skill name:** `okhp3-askjamie-gpt-builder`
- **Purpose:** Build, audit, improve, package, and govern AskJamie Custom GPTs as calm, architected helpdesk and interpretive-intelligence experiences.
- **Version:** `1.0.0`
...
4. Preserve the `name: okhp3-askjamie-gpt-builder` metadata and folder-name match.
...
- Public positioning reference: https://askjamie.bot
- Apply the AskJamie identity contract in `SKILL.md` before the generic GPT lifecycle.
- Favor plain-language walkthroughs, visible decision trees, diagrams, tradeoffs, and next steps.
- Keep the tone calm and warm without hiding uncertainty, disagreement, or material risk.
- Route execution-oriented work to Glee-fully Tools and strategy/narrative work to the appropriate OverKill Hill surface.
